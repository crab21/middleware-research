...
func TestCygwinPipeName(t *testing.T) {
	tests := []struct {
		...
		{`\Device\NamedPipe\cygwin-e022582115c10879-pty4-from-main`, true},
		{`\Device\NamedPipe\msys-e022582115c10879-pty4-to-main`, true},
		{`Device\NamedPipe\cygwin-e022582115c10879-pty4-to-main`, false},
	}
