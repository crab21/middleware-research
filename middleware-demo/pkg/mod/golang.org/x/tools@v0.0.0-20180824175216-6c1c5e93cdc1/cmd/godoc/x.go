...
<meta name="go-source" content="golang.org{{.Prefix}}{{.Head}} https://github.com/golang/{{.Head}}/ https://github.com/golang/{{.Head}}/tree/main{/dir} https://github.com/golang/{{.Head}}/blob/main{/dir}/{file}#L{line}">
