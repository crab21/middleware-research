...
type SetMainAuthRequest struct {
	...
	Action SetMainAuthRequest_Action `protobuf:"varint,4,opt,name=action,proto3,enum=google.container.v1.SetMainAuthRequest_Action" json:"action,omitempty"`
	// A description of the update.
...
func init() {
	...
	proto.RegisterEnum("google.container.v1.SetMainAuthRequest_Action", SetMainAuthRequest_Action_name, SetMainAuthRequest_Action_value)
	...
	proto.RegisterType((*MainAuth)(nil), "google.container.v1.MainAuth")
	...
	proto.RegisterType((*MainAuthorizedNetworksConfig)(nil), "google.container.v1.MainAuthorizedNetworksConfig")
	proto.RegisterType((*MainAuthorizedNetworksConfig_CidrBlock)(nil), "google.container.v1.MainAuthorizedNetworksConfig.CidrBlock")
	...
	proto.RegisterType((*UpdateMainRequest)(nil), "google.container.v1.UpdateMainRequest")
	proto.RegisterType((*SetMainAuthRequest)(nil), "google.container.v1.SetMainAuthRequest")
...
func (c *clusterManagerClient) UpdateMain(ctx context.Context, in *UpdateMainRequest, opts ...grpc.CallOption) (*Operation, error) {
	out := new(Operation)
	err := c.cc.Invoke(ctx, "/google.container.v1.ClusterManager/UpdateMain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterManagerClient) SetMainAuth(ctx context.Context, in *SetMainAuthRequest, opts ...grpc.CallOption) (*Operation, error) {
	out := new(Operation)
	err := c.cc.Invoke(ctx, "/google.container.v1.ClusterManager/SetMainAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClusterManager_UpdateMain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.container.v1.ClusterManager/UpdateMain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClusterManager_SetMainAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.container.v1.ClusterManager/SetMainAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
